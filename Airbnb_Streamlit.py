...
if selected == 'Home':
    ...
    # st.map(df,latitude=df['latitude'],longitude=df['longitude'],use_container_width=True,size=1)

    fig = px.scatter_mapbox(df,lat = 'latitude',lon='longitude',zoom=9.3,width=1400,height=600,hover_data='neighbourhood',hover_name='neighbourhood_group')
    fig.update_layout(mapbox_style='carto-darkmatter')
    fig.update_layout(margin={'r':0,'t':50,'l':0,'b':10})
    fig.update_geos(fitbounds="locations")
    st.plotly_chart(fig)
    
    st.markdown("# Price Analysis with all Locations")
    fig = px.scatter_mapbox(df,lat='latitude',lon='longitude',zoom=9.3,color='price',width=1400,height=600,color_continuous_scale='jet',size = 'price',size_max=50,hover_data='neighbourhood',hover_name='neighbourhood_group')
    ...
    st.markdown("# Neighbourhood Group vs Price")
    fig = px.scatter_mapbox(df,lat='latitude',lon='longitude',zoom=9.3,color='neighbourhood_group',width=1400,height=600,color_continuous_scale='jet',size = 'price',size_max=50,hover_data='neighbourhood')
    fig.update_layout(mapbox_style='carto-darkmatter')
    fig.update_layout(margin={'r':0,'t':50,'l':0,'b':10})
    fig.update_geos(fitbounds="locations")
    st.plotly_chart(fig)

    st.markdown("# Neighbourhood vs Price")
    fig = px.scatter_mapbox(df,lat='latitude',lon='longitude',zoom=9.3,color='neighbourhood',width=1400,height=600,color_continuous_scale='jet',size = 'price',size_max=50,hover_data='neighbourhood_group')
    fig.update_layout(mapbox_style='carto-positron')
    fig.update_layout(margin={'r':0,'t':50,'l':0,'b':10})
    fig.update_geos(fitbounds="locations")
    st.plotly_chart(fig)
    ...
    st.markdown("# Room Type vs Price")
    fig = px.scatter_mapbox(df,lat='latitude',lon='longitude',zoom=9.3,color='room_type',width=1400,height=600,size = 'price',size_max=50,hover_name='neighbourhood_group',hover_data='neighbourhood')
    fig.update_layout(mapbox_style='carto-darkmatter')
    fig.update_layout(margin={'r':0,'t':50,'l':0,'b':10})
    fig.update_geos(fitbounds="locations")
    st.plotly_chart(fig)
